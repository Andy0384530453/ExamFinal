...
class DataInitializerTest {
  ...
  void run_seeds_all_three_users_when_none_exist() {
    ...
    JUser student = savedUsers.stream().filter(u -> u.getRole() == Role.STUDENT).findFirst().orElseThrow();
    ...
    JUser teacher = savedUsers.stream().filter(u -> u.getRole() == Role.TEACHER).findFirst().orElseThrow();
    ...
    JUser admin = savedUsers.stream().filter(u -> u.getRole() == Role.ADMIN).findFirst().orElseThrow();
